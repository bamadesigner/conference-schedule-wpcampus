						...
						<tr>
							<td>
								<fieldset>
									...
									<label for="conf-schedule-display-video"><input type="checkbox" name="conf_schedule[schedule_display_fields][]" id="conf-schedule-display-video" value="watch_video"<?php checked( is_array( $display_fields ) && in_array( 'watch_video', $display_fields ) ); ?> /> <?php _e( 'Session video', 'conf-schedule' ); ?></label><br>
                                    <label for="conf-schedule-display-discussion"><input type="checkbox" name="conf_schedule[schedule_display_fields][]" id="conf-schedule-display-discussion" value="join_discussion"<?php checked( is_array( $display_fields ) && in_array( 'join_discussion', $display_fields ) ); ?> /> <?php _e( 'Join the discussion', 'conf-schedule' ); ?></label>
								</fieldset>
							</td>
						</tr>
						<tr>
